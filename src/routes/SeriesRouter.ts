...
SeriesRoutes.post('/series/name', (req, res) => {
    req.app.seriesController.setName(req.body.name);
    res.sendStatus(200);
});

SeriesRoutes.post('/series', (req, res) => {
    req.app.seriesController.setName(req.body.name);
...
SeriesRoutes.put('/series/game', (req, res) => {
    req.app.seriesController.addGame();
    res.sendStatus(200);
});

SeriesRoutes.delete('/series/game', (req, res) => {
    req.app.seriesController.deleteGame();
    res.sendStatus(200);
});

SeriesRoutes.put('/series/bestof', (req, res) => {
    req.app.seriesController.setBestOf(req.body.bestOf);
    res.sendStatus(200);
});
...
SeriesRoutes.delete('/series', (req, res) => {
